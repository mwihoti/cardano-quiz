...
import { Users, Crown, CheckCircle2, XCircle, Lock, Trophy, ArrowRight, ArrowLeft, LogOut } from "lucide-react";
      ...
      <div className="min-h-dvh flex flex-col items-center justify-center p-6 pb-safe">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm space-y-6">
          <div className="flex items-center justify-between">
            <button onClick={() => { clearSession(); nav("/"); }} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
